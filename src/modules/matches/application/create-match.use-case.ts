...
export class CreateMatchUseCase {
  ...
  async execute(phaseId:string, homeTeamId: string, awayTeamId: string, homeScore: number, awayScore: number, status: string, scheduledAt: Date, groupId: string): Promise<Match> {
